    ...
    <div className="bottom-0 text-center lg:text-left bg-white text-gray-800">
        <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
            ...
            <a href="#!" className="text-black-900">
                <img className='w-4' src="https://www.svgrepo.com/show/333611/tiktok.svg" alt="" />
            </a>
            </div>
        </div>
        <div className="mx-6 py-10 text-center md:text-left">
            ...
            <div className="">
                ...
                <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis ipsum tempora provident tenetur in 
                </p>
            </div>
            <div className="pl-7">
                ...
                <p className="mb-4">
                <a href="#!" className="text-gray-800">Tarifs</a>
                </p>
                <p className="mb-4">
                <a href="#!" className="text-gray-800">FAQ</a>
                </p>
                <p>
                <a href="#!" className="text-gray-800">Team & Careers</a>
                </p>
            </div>
            <div className="">
                <h6 className="uppercase font-bold mb-4 flex justify-center md:justify-start">
                ...
                <p className="mb-4">
                <a href="#!" className="text-gray-800">Acceuil</a>
                </p>
                <p className="mb-4">
                <a href="#!" className="text-gray-800">Apropos</a>
                </p>
                <p className="mb-4">
                <a href="#!" className="text-gray-800">Contactez-nous</a>
                </p>
                <p>
        ...
        <div className="text-center p-6 text-white bg-gray-900">
