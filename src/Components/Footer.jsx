...
const Footer = () => {
  return (
    ...
    <footer class="text-center lg:text-left bg-white text-gray-800">
        <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
            <div class="mr-12 hidden lg:block">
            <span>Suivez nous sur nos differents reseaux:</span>
            </div>
            <div class="flex justify-center">
            <a href="#!" class="mr-6 text-blue-900">
        ...
        <div class="mx-6 py-10 text-center md:text-left">
            ...
            <div class="pl-7">
                ...
                <p class="mb-4">
                <a href="#!" class="text-gray-800">Prices</a>
                </p>
                <p class="mb-4">
                <a href="#!" class="text-gray-800">FAQ</a>
                </p>
                <p>
                <a href="#!" class="text-gray-800">Team & Careers</a>
                </p>
            </div>
            <div class="">
                <h6 class="uppercase font-bold mb-4 flex justify-center md:justify-start">
                ...
                <p>
                <a href="#!" class="text-gray-800">Blog</a>
                </p>
            </div>
            <div class="">
        ...
        <div class="text-center p-6 text-white bg-gray-900">
            <span>© 2023 Copyright: </span>
            <a class="text-white font-semibold" href="">StudeFly</a>
        </div>
        </footer>
