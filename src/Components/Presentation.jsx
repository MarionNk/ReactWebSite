...
export default function Presentation() {
  return (
    ...
    <div class=" pt-24">
		...
		<div class=" max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start  lg:px-12">
			{/* <!--Left Col--> */}
			<div class="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
				<h1 data-aos="fade-right" data-aos-once="true" class="my-4 text-4xl lg:text-5xl font-bold leading-tight text-darken">
					<span class="text-blue-900">Etudier</span> en France est beaucoup plus facile
				</h1>
				<p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" class="leading-normal text-gray-600 text-lg mb-8">StudeFly est une plateforme numerique, securisee et multiservices, dediee tout d'abord aux etudiants, ensuite a tous ceux qui ont besoin de ses services</p>
				<div data-aos="fade-up" data-aos-once="true" data-aos-delay="700" class="z-40 w-full md:flex items-center justify-center lg:justify-start md:space-x-5">
					<button class="lg:mx-0 bg-blue-900 text-white text-lg font-bold rounded-full py-4 px-9 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out">
						Nous rejoindre
					</button>
					<div class="flex items-center justify-center space-x-3 mt-5 md:mt-0 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out">
						<button class=" bg-white shadow-xl w-14 h-14 rounded-full flex items-center justify-center">
						...
						<span class="cursor-pointer font-bold text-md">Voir comment ca marche</span>
					</div>
				</div>
			</div>
			{/* <!--Right Col--> */}
			<div class="w-full lg:w-8/12 lg:mt-10 relative">
				<img data-aos="fade-up" data-aos-once="true" class="w-8/12 mx-auto 2xl:-mb-20" src={search} />
				{/* <!-- calendar --> */}
				<div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="absolute top-5 -left-6 sm:top-32 sm:left-10 md:top-40 md:left-16 lg:left-25 lg:top-0 floating-4">
					<img class="bg-white bg-opacity-80 rounded-lg h-12 sm:h-16" src={calendar}/>
				</div>
				{/* <!-- red --> */}
				<div data-aos="fade-up" data-aos-delay="400" data-aos-once="true" class="absolute top-5 right-10 sm:right-24 sm:top-28 md:top-36 md:right-32 lg:top-5 lg:right-16 floating">
				...
				{/* <!-- ux class --> */}
				<div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" class="absolute bottom-16 -left-4 sm:left-2 sm:bottom-20 lg:bottom-56 lg:-left-1 floating">
					<img class="bg-white bg-opacity-80 rounded-lg h-20 sm:h-28" src={uxclass} alt=""/>
				</div>
				{/* <!-- congrats --> */}
		...
		{/* <div class="text-white -mt-14 sm:-mt-24 lg:-mt-36  relative">
