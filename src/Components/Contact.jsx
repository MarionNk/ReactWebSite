        ...
        <section className="bg-white lg:col-span-2  p-5 col-span-5">
            <div className="py-3 lg:py-5 px-4 mx-auto max-w-screen-md">
                ...
                <form action="#" className="space-y-4">
                    <div>
                        <label for="email" className="block mb-1 text-dmd font-bold text-gray-900 ">Your email</label>
                    ...
                    <div>
                        <label for="subject" className="block mb-1 text-dmd font-bold text-gray-900 ">Subject</label>
                    ...
                    <div className="dmd:col-span-2">
                        <label for="message" className="block mb-1 text-dmd font-bold text-gray-900 ">Your message</label>
